...
// expected while the database is down: 503 when no connection could be opened (nothing happened),
// 500 when the database died mid-registration (the welcome email may already be queued)
