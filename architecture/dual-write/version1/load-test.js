...
const emailsSent = new Counter('welcome_emails_sent');
const emailsLost = new Counter('welcome_emails_lost');
...
export default function () {
  ...
  usersCreated.add(1);
  if (res.json('welcomeEmailSent')) emailsSent.add(1);
  else emailsLost.add(1);
}
