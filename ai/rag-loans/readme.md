...
3. **Embed** — each chunk converted to a 384-d vector
   ...
   ```
   "Personal loans require a minimum FICO of 660." → [0.0521, -0.1843, 0.3012, ...]

   "What credit score do I need for a loan?"       → [0.0489, -0.1901, 0.3144, ...]  ← close
   "Personal loans require a minimum FICO..."      → [0.0521, -0.1843, 0.3012, ...]  ← close
   "How long does mortgage closing take?"          → [-0.1200, 0.2744, -0.0831, ...] ← far
   ```
